...
class IDBChangedHook(ida_idp.IDB_Hooks):
    ...
    def determined_main(self, main: int) -> None:
        ...
        ev = determined_main_event(
            event_name="determined_main", timestamp=datetime.now(), main=main
        )
    ...
    def adding_segm(self, s: ida_segment.segment_t) -> None:
        ...
        ev = adding_segm_event(
            event_name="adding_segm", timestamp=datetime.now(), s=s_model
        )
        self.events.add_event(ev)
    ...
    def segm_added(self, s: ida_segment.segment_t) -> None:
        ...
        ev = segm_added_event(
            event_name="segm_added", timestamp=datetime.now(), s=s_model
        )
        self.events.add_event(ev)
    ...
    def deleting_segm(self, start_ea: int) -> None:
        ...
        ev = deleting_segm_event(
            event_name="deleting_segm", timestamp=datetime.now(), start_ea=start_ea
        )
        self.events.add_event(ev)
    ...
    def segm_start_changed(self, s: ida_segment.segment_t, oldstart: int) -> None:
        ...
        s_model = SegmentModel.from_segment_t(s)
        logger.debug(
            "segm_start_changed(s=%s, oldstart=%d)", s_model.model_dump_json(), oldstart
        )
    ...
    def segm_end_changed(self, s: ida_segment.segment_t, oldend: int) -> None:
        ...
        s_model = SegmentModel.from_segment_t(s)
        logger.debug(
            "segm_end_changed(s=%s, oldend=%d)", s_model.model_dump_json(), oldend
        )
        ev = segm_end_changed_event(
    ...
    def changing_segm_name(self, s: ida_segment.segment_t, oldname: str) -> None:
        ...
        s_model = SegmentModel.from_segment_t(s)
        logger.debug(
            "changing_segm_name(s=%s, oldname=%s)", s_model.model_dump_json(), oldname
        )
    ...
    def segm_name_changed(self, s: ida_segment.segment_t, name: str) -> None:
        ...
        s_model = SegmentModel.from_segment_t(s)
        logger.debug(
            "segm_name_changed(s=%s, name=%s)", s_model.model_dump_json(), name
        )
        ev = segm_name_changed_event(
    ...
    def changing_segm_class(self, s: ida_segment.segment_t) -> None:
        ...
        ev = changing_segm_class_event(
            event_name="changing_segm_class", timestamp=datetime.now(), s=s_model
        )
        self.events.add_event(ev)
    ...
    def segm_class_changed(self, s: ida_segment.segment_t, sclass: str) -> None:
        ...
        s_model = SegmentModel.from_segment_t(s)
        logger.debug(
            "segm_class_changed(s=%s, sclass=%s)", s_model.model_dump_json(), sclass
        )
    ...
    def segm_attrs_updated(self, s: ida_segment.segment_t) -> None:
        ...
        ev = segm_attrs_updated_event(
            event_name="segm_attrs_updated", timestamp=datetime.now(), s=s_model
        )
        self.events.add_event(ev)
    ...
    def allsegs_moved(self, info: ida_moves.segm_move_infos_t) -> None:
        ...
        ev = allsegs_moved_event(
            event_name="allsegs_moved", timestamp=datetime.now(), moves=moves
        )
        self.events.add_event(ev)
    ...
    def func_added(self, pfn: ida_funcs.func_t) -> None:
        ...
        ev = func_added_event(
            event_name="func_added", timestamp=datetime.now(), pfn=pfn_model
        )
        self.events.add_event(ev)
    ...
    def func_updated(self, pfn: ida_funcs.func_t) -> None:
        ...
        ev = func_updated_event(
            event_name="func_updated", timestamp=datetime.now(), pfn=pfn_model
        )
        self.events.add_event(ev)
    ...
    def set_func_end(self, pfn: ida_funcs.func_t, new_end: int) -> None:
        ...
        pfn_model = FuncModel.from_func_t(pfn)
        logger.debug(
            "set_func_end(pfn=%s, new_end=%d)", pfn_model.model_dump_json(), new_end
        )
        ev = set_func_end_event(
    ...
    def deleting_func(self, pfn: ida_funcs.func_t) -> None:
        ...
        ev = deleting_func_event(
            event_name="deleting_func", timestamp=datetime.now(), pfn=pfn_model
        )
        self.events.add_event(ev)
    ...
    def thunk_func_created(self, pfn: ida_funcs.func_t) -> None:
        ...
        ev = thunk_func_created_event(
            event_name="thunk_func_created", timestamp=datetime.now(), pfn=pfn_model
        )
        self.events.add_event(ev)
    ...
    def func_noret_changed(self, pfn: ida_funcs.func_t) -> None:
        ...
        ev = func_noret_changed_event(
            event_name="func_noret_changed", timestamp=datetime.now(), pfn=pfn_model
        )
        self.events.add_event(ev)
    ...
    def updating_tryblks(self, tbv) -> None:
        ...
        ev = updating_tryblks_event(
            event_name="updating_tryblks", timestamp=datetime.now(), tryblks=tryblks
        )
        self.events.add_event(ev)
    ...
    def tryblks_updated(self, tbv) -> None:
        ...
        ev = tryblks_updated_event(
            event_name="tryblks_updated", timestamp=datetime.now(), tryblks=tryblks
        )
        self.events.add_event(ev)
    ...
    def deleting_tryblks(self, range: ida_range.range_t) -> None:
        ...
        ev = deleting_tryblks_event(
            event_name="deleting_tryblks", timestamp=datetime.now(), range=range_model
        )
        self.events.add_event(ev)
    ...
    def make_code(self, insn: ida_ua.insn_t) -> None:
        ...
        ev = make_code_event(
            event_name="make_code", timestamp=datetime.now(), insn=insn_model
        )
        self.events.add_event(ev)
    ...
    def dirtree_mkdir(self, dt: ida_dirtree.dirtree_t, path: str) -> None:
        ...
        ev = dirtree_mkdir_event(
            event_name="dirtree_mkdir", timestamp=datetime.now(), path=path
        )
        self.events.add_event(ev)
    ...
    def dirtree_rmdir(self, dt: ida_dirtree.dirtree_t, path: str) -> None:
        ...
        ev = dirtree_rmdir_event(
            event_name="dirtree_rmdir", timestamp=datetime.now(), path=path
        )
        self.events.add_event(ev)
    ...
    def dirtree_link(self, dt: ida_dirtree.dirtree_t, path: str, link: bool) -> None:
        ...
        ev = dirtree_link_event(
            event_name="dirtree_link", timestamp=datetime.now(), path=path, link=link
        )
        self.events.add_event(ev)
    ...
    def dirtree_move(self, dt: ida_dirtree.dirtree_t, _from: str, to: str) -> None:
        ...
        ev = dirtree_move_event(
            event_name="dirtree_move", timestamp=datetime.now(), _from=_from, to=to
        )
        self.events.add_event(ev)
    ...
    def dirtree_rank(self, dt: ida_dirtree.dirtree_t, path: str, rank: int) -> None:
        ...
        ev = dirtree_rank_event(
            event_name="dirtree_rank", timestamp=datetime.now(), path=path, rank=rank
        )
        self.events.add_event(ev)
    ...
    def dirtree_rminode(self, dt: ida_dirtree.dirtree_t, inode: int) -> None:
        ...
        ev = dirtree_rminode_event(
            event_name="dirtree_rminode", timestamp=datetime.now(), inode=inode
        )
        self.events.add_event(ev)
    ...
    def dirtree_segm_moved(self, dt: ida_dirtree.dirtree_t) -> None:
        ...
        ev = dirtree_segm_moved_event(
            event_name="dirtree_segm_moved", timestamp=datetime.now()
        )
        self.events.add_event(ev)
    ...
    def lt_udm_created(self, udtname: str, udm: ida_typeinf.udm_t) -> None:
        ...
        logger.debug(
            "lt_udm_created(udtname=%s, udm=%s)", udtname, udm_model.model_dump_json()
        )
        ev = lt_udm_created_event(
    ...
    def lt_edm_created(self, enumname: str, edm: ida_typeinf.edm_t) -> None:
        ...
        logger.debug(
            "lt_edm_created(enumname=%s, edm=%s)", enumname, edm_model.model_dump_json()
        )
    ...
    def stkpnts_changed(self, pfn: ida_funcs.func_t) -> None:
        ...
        ev = stkpnts_changed_event(
            event_name="stkpnts_changed", timestamp=datetime.now(), pfn=pfn_model
        )
        self.events.add_event(ev)
    ...
    def frame_deleted(self, pfn: ida_funcs.func_t) -> None:
        ...
        ev = frame_deleted_event(
            event_name="frame_deleted", timestamp=datetime.now(), pfn=pfn_model
        )
        self.events.add_event(ev)
